...
<body>
	<div id="wrap">
			...
			<div class="row border-bottom">
            	...
            	<div class="col-lg-10">
              	<ol class="breadcrumb">
                	...
                	<?php if(isset($space)): ?><li><a href="<?php echo U('Picserver/space/'.$space['name']).'?page=1';?>"><?php echo ($space["name"]); ?></a></li><?php endif; ?>
                	<?php if(isset($picture)): ?><li><?php echo ($picture["name"]); ?></li><?php endif; ?>
			...
			<div class="col-md-12 dashboard-heading">
            	...
            	<div class="row">
            		<div class="user-info col-md-4">
	             	...
	             	<div class="cloud-info col-md-4">
			  					<div class="info-header">图片云信息</div>
					          		...
					          		<div>
                        	<span>存储空间：</span>
                          	<small class="pull-right"><?php echo sprintf("%.2f", $user['totSize']);?> MB</small>
			                  </div>
			                  <div class="progress progress-small">
			                  	<div style="width: 60%;" class="progress-bar progress-default"></div>
					  					...
					  					<div class="info-item">
                      	<span>图片空间数：</span>
                      	<small class="pull-right"><?php echo ($user["spaceNum"]); ?></small>
                    	</div>
                    	<div class="hr-line-dashed"></div>
					  					<div class="info-item">
                      	<span>总图片数：</span>
                      	<small class="pull-right"><?php echo ($user["picNum"]); ?></small>
                    	</div>
                    	<div class="hr-line-dashed"></div>
                			<div class="info-item">
                      	<span>已使用流量：</span>
                  ...
                  <div class="flot-chart">
                      <?php if(!isset($spaces)): ?>还未创建空间<?php endif; ?>
      ...
      <div id="uid" style="display:none"><?php echo session('uid');?></div>
			<div class="col-md-6">
				<div class="ibox">
        	<div class="ibox-title">
        		<h5> 空间信息</h5>
              ...
              <?php if(!isset($spaces)): ?>还未创建空间<?php endif; ?>
         			<?php if(is_array($spaces)): $k = 0; $__LIST__ = $spaces;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$space): $mod = ($k % 2 );++$k;?><div class="info-item">
	    						<span class="label label-success"><?php echo ($k); ?></span>
	              	<a href="#"><span><?php echo ($space["name"]); ?></span></a>
	              	<small class="pull-right"><?php echo ($space["number"]); ?>张 / <?php echo ($space["storage"]); ?>MB</small>
	            	</div>
								<div class="hr-line-dashed"></div><?php endforeach; endif; else: echo "" ;endif; ?>
  					</div>
  				</div>
  			</div>
			</div>
        	...
        	<div class="ibox-title">
              ...
              <?php if(!isset($log_pages)): ?>未进行任何操作<?php endif; ?>
	         			<?php if(is_array($log_pages)): $i = 0; $__LIST__ = array_slice($log_pages,0,2,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$log): $mod = ($i % 2 );++$i;?><div class="info-item">
	      						<p><?php echo ($log["operation"]); ?></p>
										<small class="block text-muted"><i class="fa fa-clock-o"></i> <?php echo timestr_totime($log['time']);?></small>
	              	</div>
	              	<div class="hr-line-dashed"></div><?php endforeach; endif; else: echo "" ;endif; ?>
    					</div>
    				</div>
